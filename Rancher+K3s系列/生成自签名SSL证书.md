...
> 参考地址[https://docs.rancher.cn/docs/rancher2/installation/options/self-signed-ssl/_index](https://docs.rancher.cn/docs/rancher2/installation/options/self-signed-ssl/_index)
...
![image-20190328180337080](img/image-20190328180337080.png)

`openssl x509 -in tls.crt -noout -text`执行后查看对应的域名和扩展 iP 是否正确

![image-20190328180455485](img/image-20190328180455485.png)
...
![image-20180805213034249](img/image-20180805213034249.png)
...
![image-20180805213123781](img/image-20180805213123781.png)